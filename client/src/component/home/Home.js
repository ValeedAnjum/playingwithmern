                                                ...
                                                <div className="slick-list draggable">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="#" title="" className="followw" tabIndex="-1">Follow</a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a href="#" title="" className="hire" tabIndex="-1">hire</a>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="#" title="" className="envlp" tabIndex="-1"><img src="images/envelop.png" alt=""/></a>
                                                                </li>
                                                                <li>
                                                                    <a href="#" title="" className="hire" tabIndex="-1">hire</a>
                                                                </li>
                                                        ...
                                                        <div
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="#" title="" className="followw" tabIndex="0">Follow</a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a href="#" title="" className="hire" tabIndex="0">hire</a>
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="#" title="" className="envlp" tabIndex="0"><img src="images/envelop.png" alt=""/></a>
                                                                </li>
                                                                <li>
                                                                    <a href="#" title="" className="hire" tabIndex="0">hire</a>
                                                                </li>
